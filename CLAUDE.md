# AI Orchestrator Source Repo

This repository contains the reusable AI Orchestrator toolkit.

Primary agent rules live in:

```text
orchestrator/AGENT_RULES.md
```

Use the source-repo wrappers when testing locally:
